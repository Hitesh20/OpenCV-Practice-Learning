...
for contour in contours:
    ## this method approximates polygonal curves with a specific persicion
    ...
    if len(approx) == 3:
        ...
        cv2.putText(img, "Star", (x,y), cv2.FONT_HERSHEY_COMPLEX, 0.5, (0,255,0))
    else:
